    ...
    return {
        "query": {"bool": {
            "must": [{"multi_match": {
                ...
                # (실측: '월세 지원' 2,425→356건) → 2단어 이하 전부 필수, 3단어 이상 75%.
                "minimum_should_match": "2<75%",
                # 오타 허용: 단어 길이별 편집거리 자동(1~2자 0, 3~5자 1, 6자+ 2).
                # '월세치원'→'월세지원' 류 1글자 오타 흡수. 시험 도입(2026-07-14) —
                # 오탐 증가량 관찰 후 유지/롤백 결정. 롤백 = 이 줄 삭제(재색인 불필요).
                "fuzziness": "AUTO",
            }}],
